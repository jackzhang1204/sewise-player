...
function(){var a=b.currentTime();f.timeUpdate(a);e.onPlayTime(a)});SewisePlayer.CommandDispatcher.addEventListener(SewisePlayer.Events.LOAD_PROGRESS,function(a){f.loadedProgress(a.progress)});SewisePlayer.IVodPlayer.play=function(){b.play()};SewisePlayer.IVodPlayer.pause=function(){b.pause()};SewisePlayer.IVodPlayer.seek=function(a){b.seek(a);e.onSeek(a)};SewisePlayer.IVodPlayer.stop=function(){b.stop();e.onStop()};SewisePlayer.IVodPlayer.changeClarity=function(){};SewisePlayer.IVodPlayer.setVolume=
function(a){b.volume(a)};SewisePlayer.IVodPlayer.muted=function(a){b.muted(a)};SewisePlayer.IVodPlayer.toPlay=function(b,c,e,d){a.videoUrl=b;a.startTime=e;a.autoStart=d;SewisePlayer.CommandDispatcher.dispatchEvent({type:SewisePlayer.Events.STREAMS_DATA_READY})};SewisePlayer.IVodPlayer.duration=function(){return b.duration()};SewisePlayer.IVodPlayer.playTime=function(){return b.currentTime()};SewisePlayer.IVodPlayer.type=function(){};SewisePlayer.IVodPlayer.showTextTip=function(){};SewisePlayer.IVodPlayer.hideTextTip=
function(){};this.doPlay=function(){SewisePlayer.IVodPlayer.play()};this.doPause=function(){SewisePlayer.IVodPlayer.pause()};this.doSeek=function(a){SewisePlayer.IVodPlayer.seek(a)};this.doStop=function(){SewisePlayer.IVodPlayer.stop()};this.setVolume=function(a){SewisePlayer.IVodPlayer.setVolume(a)};this.duration=function(){return SewisePlayer.IVodPlayer.duration()};this.playTime=function(){return SewisePlayer.IVodPlayer.playTime()};this.toPlay=function(a,b,c,e){SewisePlayer.IVodPlayer.toPlay(a,
b,c,e)};this.playerReady=function(){d||(d=!0,window.playerReady&&"function"==typeof window.playerReady&&window.playerReady())};this.onStart=function(a){if(window.onStart&&"function"==typeof window.onStart)window.onStart(a)};this.onStop=function(a){if(window.onStop&&"function"==typeof window.onStop)window.onStop(a)};this.onMetadata=function(a,b){if(window.onMetadata&&"function"==typeof window.onMetadata)window.onMetadata(a,b)};this.onClarity=function(a,b){if(window.onClarity&&"function"==typeof window.onClarity)window.onClarity(a,
b)};this.onPause=function(a){if(window.onPause&&"function"==typeof window.onPause)window.onPause(a)};this.onSeek=function(a,b){if(window.onSeek&&"function"==typeof window.onSeek)window.onSeek(a,b)};this.onPlayTime=function(a,b){if(window.onPlayTime&&"function"==typeof window.onPlayTime)window.onPlayTime(a,b)}}})();(function(){SewisePlayer.VodMediaStreams=function(c,a){function e(){f.getStreams()}function b(){SewisePlayer.CommandDispatcher.dispatchEvent({type:SewisePlayer.Events.STREAMS_DATA_READY})}var f=this;SewisePlayer.CommandDispatcher.addEventListener(SewisePlayer.Events.PARAMS_READY,function(){a.skin?SewisePlayer.PlayerSkinLoader(c,a.skin):f.getStreams()});SewisePlayer.CommandDispatcher.addEventListener(SewisePlayer.Events.PLAYER_SKIN_LOADED,e);SewisePlayer.CommandDispatcher.addEventListener(SewisePlayer.Events.PLAYER_SKIN_LOADED_ERROR,
...
function(){var a=b.currentTime();f.timeUpdate(a);e.onPlayTime(a)});SewisePlayer.CommandDispatcher.addEventListener(SewisePlayer.Events.LOAD_PROGRESS,function(a){f.loadedProgress(a.progress)});SewisePlayer.ILivePlayer.live=function(){b.play()};SewisePlayer.ILivePlayer.play=function(){b.play()};SewisePlayer.ILivePlayer.pause=function(){b.pause()};SewisePlayer.ILivePlayer.seek=function(){};SewisePlayer.ILivePlayer.stop=function(){b.stop();e.onStop()};SewisePlayer.ILivePlayer.changeClarity=function(){};
SewisePlayer.ILivePlayer.setVolume=function(a){b.volume(a)};SewisePlayer.ILivePlayer.muted=function(a){b.muted(a)};SewisePlayer.ILivePlayer.toPlay=function(b,c,e,d){a.streamUrl=b;a.shiftTime=e;a.autoStart=d;SewisePlayer.CommandDispatcher.dispatchEvent({type:SewisePlayer.Events.STREAMS_DATA_READY})};SewisePlayer.ILivePlayer.duration=function(){return 0};SewisePlayer.ILivePlayer.liveTime=function(){return 0};SewisePlayer.ILivePlayer.playTime=function(){return b.currentTime()};SewisePlayer.ILivePlayer.type=
...
this.playTime=function(){return SewisePlayer.ILivePlayer.playTime()};this.toPlay=function(a,b,c,e){SewisePlayer.ILivePlayer.toPlay(a,b,c,e)};this.playerReady=function(){d||(d=!0,window.playerReady&&"function"==typeof window.playerReady&&window.playerReady())};this.onStart=function(a){if(window.onStart&&"function"==typeof window.onStart)window.onStart(a)};this.onStop=function(a){if(window.onStop&&"function"==typeof window.onStop)window.onStop(a)};this.onMetadata=function(a,b){if(window.onMetadata&&
"function"==typeof window.onMetadata)window.onMetadata(a,b)};this.onClarity=function(a,b){if(window.onClarity&&"function"==typeof window.onClarity)window.onClarity(a,b)};this.onPause=function(a){if(window.onPause&&"function"==typeof window.onPause)window.onPause(a)};this.onSeek=function(a,b){if(window.onSeek&&"function"==typeof window.onSeek)window.onSeek(a,b)};this.onPlayTime=function(a,b){if(window.onPlayTime&&"function"==typeof window.onPlayTime)window.onPlayTime(a,b)}}})();(function(){SewisePlayer.LiveMediaStreams=function(c,a){function e(){f.getLiveStreams()}function b(){SewisePlayer.CommandDispatcher.dispatchEvent({type:SewisePlayer.Events.STREAMS_DATA_READY})}var f=this;SewisePlayer.CommandDispatcher.addEventListener(SewisePlayer.Events.PARAMS_READY,function(){a.skin?SewisePlayer.PlayerSkinLoader(c,a.skin):f.getLiveStreams()});SewisePlayer.CommandDispatcher.addEventListener(SewisePlayer.Events.PLAYER_SKIN_LOADED,e);SewisePlayer.CommandDispatcher.addEventListener(SewisePlayer.Events.PLAYER_SKIN_LOADED_ERROR,
...
b,f)},SewisePlayer.toPlay=function(c,b,f,d){a.toPlay(c,b,f,d)}}})();(function(){SewisePlayer.Html5ExternalInterface=function(c,a){if(c==SewisePlayer.GlobalConst.VOD)SewisePlayer.doPlay=function(){a.doPlay()},SewisePlayer.doPause=function(){a.doPause()},SewisePlayer.doSeek=function(c){a.doSeek(c)},SewisePlayer.doStop=function(){a.doStop()},SewisePlayer.setVolume=function(c){a.setVolume(c)},SewisePlayer.duration=function(){return a.duration()},SewisePlayer.playTime=function(){return a.playTime()},SewisePlayer.toPlay=function(c,b,f,d){a.toPlay(c,b,f,d)};else if(c==SewisePlayer.GlobalConst.LIVE)SewisePlayer.doPlay=
