...
package  {
	...
	import skins.black.BigIconContainer;
	import skins.black.BufferProgress;
	import skins.black.TipBubble;
	import skins.black.controlbar.VodControlBar;
	import skins.black.settings.ClarityWindow;
	import skins.black.topbar.TopBar;
	import skins.black.videocontainer.VideoContainer;
	
	import utils.Stringer;
	
	import utils.LanguageManager;

	public class VodBlack extends MovieClip implements IVodPlayerSkin {
