 ...
 ********************************************************************************/
package  {
	import skins.orange.controlbar.VodControlBarLoopPlay;
	...
	public class VodOrangeLoopPlay extends MovieClip implements IVodPlayerSkin, IPlayerSkin{
		...
		public function VodOrangeLoopPlay() {
		...
		public function checkLoopPlay(virtualDuration:Number, virtualStartTime:String, jsLoopTotals:Number):Number
		{
			...
			/*
			var jsOutput:String = " loop play info>>"
...
/**------------------------------ 设置播放器某些数据的方法 ---------------------------*/
		...
		public function set playTime(t : Number) : void {
			...
			if(loopTotals <= 0 && _playTime >= remainderTime)
			{
				...
				/*
				var jsOutput:String = " loop play complete>>"
					+ " \n play time:" + _playTime
					+ " \n remainder time:" + remainderTime
