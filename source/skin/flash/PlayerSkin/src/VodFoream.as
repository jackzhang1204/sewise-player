...
package  {
	...
	import skins.vodfoream.BigIconContainer;
	import skins.vodfoream.BufferProgress;
	import skins.vodfoream.TipBubble;
	import skins.vodfoream.controlbar.VodControlBar;
	import skins.vodfoream.settings.ClarityWindow;
	import skins.vodfoream.topbar.TopBar;
	import skins.vodfoream.videocontainer.VideoContainer;
	
	import utils.LanguageManager;
	import utils.Stringer;

	public class VodFoream extends MovieClip implements IVodPlayerSkin, IPlayerSkin{
		...
		public function VodFoream() {
			...
			//ExternalInterface.call("jsTrace", "xxx");
		}
...
/**------------------------------ 设置播放器某些数据的方法 ---------------------------*/
		...
		public function set duration(t : Number) : void {
			...
			controlBar.durations = Stringer.secToStrMS(t);
		}
		...
		public function set playTime(t : Number) : void {
			...
			if(_playTime < 1)
			{
				controlBar.playedTime = Stringer.secToStrMS(_startTime);
			}else{
				controlBar.playedTime = Stringer.secToStrMS(_playTime);
			}
			///////////////////////////////////////////////////////////
		...
		public function set topBarDisplay(state : String) : void
		{
			...
			if(state != "enable")
			{
				...
				controlBar.topBarDisplay = false;
			}
		}
...
/**------------------------------ 私有属性和方法 ---------------------------*/
		...
		private function addedToStage(e:Event):void{
			...
			videoContainer.addEventListener(MouseEvent.CLICK, videoClickHandler);
		}
