...
package skins.vodfoream {
	...
	public class SettingWindow extends MovieClip {
		...
		//protected var _vodfoream:Orange;
		...
		private function downHandler(e:MouseEvent):void{
			//this.startDrag(false,new Rectangle(0,0,_vodfoream.bg.width - this.width,_vodfoream.bg.height-this.height));
