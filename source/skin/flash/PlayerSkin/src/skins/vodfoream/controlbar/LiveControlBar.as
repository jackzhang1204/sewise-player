...
package skins.vodfoream.controlbar {
	...
	public class LiveControlBar extends MovieClip {
		...
		public function LiveControlBar() {
			//_vodfoream = this.parent as LiveWhite;
...
/**------------------------------ 私有属性及方法 ---------------------------*/
		...
		//顶级对象
		//private var _vodfoream:LiveWhite;
		...
		private function tipShowHandler(e:MouseEvent):void{
			...
			switch(e.target){
				...
				case soundCloseBtn:
					...
					break;
				case liveBtn:
					_vodfoream.tipBubble.showInfo(backToLive_string, liveBtn.x + liveBtn.width/2, btnY, _vodfoream.x, _curW);
					break;
				case pauseBtn:
