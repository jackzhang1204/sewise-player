...
package skins.vspaas.controlbar {
	...
	public class LiveControlBar extends MovieClip {
		...
		public function LiveControlBar() {
			//_vspaas = this.parent as LiveWhite;
...
/**------------------------------ 本对象大小及显示设置方法 ---------------------------*/
		...
		public function hide():void{
			//jack zhang fix////
			//var _hideTween:Tween  = new Tween(this, "y", Regular.easeOut, this.y, _vspaas.bg.height, 1, true);
		...
		private function tipShowHandler(e:MouseEvent):void{
			...
			switch(e.target){
				...
				case soundCloseBtn:
					...
					break;
				case liveBtn:
					_vspaas.tipBubble.showInfo(backToLive_string, liveBtn.x + liveBtn.width/2, btnY, _vspaas.x, _curW);
					break;
				case pauseBtn:
