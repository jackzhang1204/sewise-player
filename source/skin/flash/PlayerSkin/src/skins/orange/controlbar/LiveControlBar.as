...
package skins.orange.controlbar {
	...
	public class LiveControlBar extends MovieClip {
		...
		public function LiveControlBar() {
			_orange = this.parent as LiveOrange;
...
/**------------------------------ 本对象大小及显示设置方法 ---------------------------*/
		...
		public function resize(w:Number,h:Number):void{
			...
			{
				clarityBtn.x = normalBtn.x - clarityBtn.width - 10;
				volumeLine.x = clarityBtn.x - volumeLine.width - 10;
			}else{
				volumeLine.x = normalBtn.x - volumeLine.width - 10;
			}
...
/**------------------------------ 私有属性及方法 ---------------------------*/
		...
		//顶级对象
		private var _orange:LiveOrange;
		//当前应用宽度
		...
		private function tipShowHandler(e:MouseEvent):void{
			...
			switch(e.target){
				...
				case soundCloseBtn:
					...
					break;
				case liveBtn:
					_orange.tipBubble.showInfo(backToLive_string, liveBtn.x + liveBtn.width/2, btnY, _orange.x, _curW);
					break;
				case pauseBtn:
