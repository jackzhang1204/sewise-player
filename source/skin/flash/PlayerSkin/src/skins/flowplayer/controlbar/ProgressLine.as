	...
	public class ProgressLine extends MovieClip {
		...
		public function resize(w:Number):void{
			...
			*/
			...
			playedLine.width = playPoint.x + playPoint.width / 2;
			_totalWidth = totalLine.width - playPoint.width;
		...
		public function setStartPosition(p:Number):void{
			...
			playedLine.width = _totalWidth * p + playPoint.width / 2;
			loadedLine.width = playedLine.width;
		}
		...
		public function setLoadProgress(p:Number):void{
			_loadPt = p;
			if(p>0) loadedLine.width = _totalWidth * (1-_startPt) * p + _totalWidth * _startPt + playPoint.width;
		}
		...
		private function seekLineHandler(e:MouseEvent):void{
			...
			playedLine.width = _seekPt * _totalWidth + playPoint.width / 2;
		...
		private function ppDownHandler(e:MouseEvent):void{
			...
			playPoint.startDrag(false,new Rectangle(0,0,totalLine.width-playPoint.width,0));
			_dragTimer.start();
		}
