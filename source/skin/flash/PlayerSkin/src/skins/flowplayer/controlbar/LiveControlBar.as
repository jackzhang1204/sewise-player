...
package skins.flowplayer.controlbar {
	...
	public class LiveControlBar extends MovieClip {
		...
		public function LiveControlBar() {
			//_flowplayer = this.parent as LiveWhite;
...
/**------------------------------ 本对象大小及显示设置方法 ---------------------------*/
		...
		public function hide():void{
			//jack zhang fix////
			//var _hideTween:Tween  = new Tween(this, "y", Regular.easeOut, this.y, _flowplayer.bg.height, 1, true);
...
/**------------------------------ 私有属性及方法 ---------------------------*/
		...
		//顶级对象
		//private var _flowplayer:LiveWhite;
		...
		private function tipShowHandler(e:MouseEvent):void{
			...
			switch(e.target){
				...
				case soundCloseBtn:
					...
					break;
				case liveBtn:
					_flowplayer.tipBubble.showInfo(backToLive_string, liveBtn.x + liveBtn.width/2, btnY, _flowplayer.x, _curW);
					break;
				case pauseBtn:
