...
package skins.flowplayer.controlbar {
	...
	import skins.flowplayer.settings.ClarityWindow;
...
/**------------------------------ 私有属性及方法 ---------------------------*/
		...
		private function tipShowHandler(e:MouseEvent):void{
			...
			switch(e.target){
				case clarityBtn:
					_flowplayer.tipBubble.showInfo(clarity_string, clarityBtn.x + clarityBtn.width/2, btnY + clarityBtn.y, _flowplayer.x, _curW);
					break;
				case soundOpenBtn:
		...
		private function volumeTipHanlder(e:MouseEvent):void{
			...
			if(value >=0 && value <= 100)
			{
				...
				_flowplayer.tipBubble.showInfo(String(value), (volumeLine.x + volumeLine.mouseX), volumeLineY, _flowplayer.x, _curW);
			}
		}
