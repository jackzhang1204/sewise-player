 ...
 ********************************************************************************/
package skins.flowplayer.topbar {
	...
	public class TopBar extends MovieClip {
		...
		public function show():void{
			...
			var _showTween:Tween = new Tween(this, "alpha", Regular.easeOut, this.alpha, 1, 0.5, true);
		...
		public function hide():void{
			...
			var _hideTween:Tween = new Tween(this, "alpha", Regular.easeOut, this.alpha, 0, 1, true);
			_hideTween.start();
		}
