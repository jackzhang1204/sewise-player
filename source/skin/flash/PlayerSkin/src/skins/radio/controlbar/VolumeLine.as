...
package skins.radio.controlbar {
	...
	public class VolumeLine extends MovieClip {
		...
		public function VolumeLine() {
			...
			volume.width = (volumeDragger.width - volumePoint.width) * _volume;
			volumePoint.x = volume.width;
		}
		...
		public function recover():void{
			...
			volume.width = volumePoint.x + volumePoint.width - volumeDragger.x - 1;
		}
		...
		public function close():void{
			...
			volume.width = volumePoint.width - 1;
		}
		...
		private function volumePointHandler(e:MouseEvent):void{
			...
			volumePoint.startDrag(false, new Rectangle(volumeDragger.x - 1, 0, volumeDragger.width - volumePoint.width + 2,  0));
			_dragTimer.start();
		}
