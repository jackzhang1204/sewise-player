...
package skins.white.controlbar {
	...
	public class VolumeLine extends MovieClip {
		...
		public function VolumeLine() {
			...
			volume.width = (volumeDragger.width - volumePoint.width) * _volume + volumePoint.width -1;
		}
		...
		private function volumePointHandler(e:MouseEvent):void{
			...
			volumePoint.startDrag(false,new Rectangle(volumeDragger.x - 1, volumeDragger.y, volumeDragger.width - volumePoint.width + 2, 0));
			_dragTimer.start();
		}
